...
export type PageName = 'home' | 'about' | 'team' | 'sectors' | 'careers' | 'products' | 'services' | 'clients' | 'testimonials' | 'blog' | 'contact' | 'admin' | 'blog-post' | 'service-detail'
...
export function RouterProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    const handleHash = () => {
      ...
      if (['home', 'about', 'team', 'sectors', 'careers', 'products', 'services', 'clients', 'testimonials', 'blog', 'contact', 'admin', 'blog-post', 'service-detail'].includes(hash)) {
