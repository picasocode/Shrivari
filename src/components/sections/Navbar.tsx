...
import { Menu, Phone, LogOut, Shield, ChevronDown, PenTool, Hammer, FlaskConical, BarChart3, ShieldCheck, RefreshCw, FileCheck, Building2, Sun, ArrowRight, Users, Briefcase, LayoutGrid, Info } from 'lucide-react'
