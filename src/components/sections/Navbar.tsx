                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 px-3.5 py-2 text-[13.5px] font-medium transition-colors rounded-md ${
                      isServicesActive
                        ...
                        : 'text-[#374151] hover:text-[#444444] hover:bg-gray-50'
                    }`}
                  >
                    {link.label}
                            ...
                            {serviceDropdownItems.map((item) => {
                              ...
                              return (
                                <button
                                  ...
                                  className="flex items-start gap-3 p-3 rounded-lg text-left transition-all duration-150 hover:bg-[#e5e5e5] group"
                                >
                                  <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-[#0D1D3A]/[0.07] flex items-center justify-center group-hover:bg-[#E8751A]/10 transition-colors">
                                    <IconComponent className="w-4 h-4 text-[#444444] group-hover:text-[#E8751A] transition-colors" />
                                  </div>
                                  <div className="min-w-0">
                                    <div className="text-[13px] font-semibold text-[#444444] group-hover:text-[#E8751A] transition-colors leading-tight">
                                      {item.label}
                                    </div>
                                    <div className="text-[13px] text-[#666666] mt-0.5 leading-snug line-clamp-2">
                                      {item.desc}
                                    </div>
                                  </div>
                                </button>
                            ...
                            {companyDropdownItems.map((item) => {
                              ...
                              return (
                                <button
                                  ...
                                  className="w-full flex items-start gap-3 p-3 rounded-lg text-left transition-all duration-150 hover:bg-[#e5e5e5] group"
                                >
                                  <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-[#0D1D3A]/[0.07] flex items-center justify-center group-hover:bg-[#E8751A]/10 transition-colors">
                                    <IconComponent className="w-4 h-4 text-[#444444] group-hover:text-[#E8751A] transition-colors" />
                                  </div>
            ...
            {isLoggedIn ? (
              <>
                <Button
                  ...
                  className="hidden md:inline-flex bg-[#0D1D3A] hover:bg-[#0D1D3A] text-[#1A1A2E] text-sm font-semibold rounded-md px-5 h-9 transition-colors"
                >
                ...
                <Button
                  onClick={onLogout}
                  variant="outline"
                  className="hidden md:inline-flex border-[#dddddd] text-[#666666] hover:text-red-600 hover:border-red-200 text-sm font-semibold rounded-md px-5 h-9 transition-colors"
                >
            ...
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              ...
              <SheetContent side="right" className="bg-white w-[280px] p-0">
                                  ...
                                  return (
                                    <SheetClose asChild key={item.slug}>
                                      <button
                                        ...
                                        className="w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-left text-[13px] text-[#374151] hover:bg-[#e5e5e5] hover:text-[#E8751A] transition-colors"
                                      >
                                        <IconComponent className="w-4 h-4 text-[#444444] flex-shrink-0" />
                ...
                <div className="p-4 border-t border-gray-100 space-y-2">
                  {isLoggedIn ? (
                    <>
                      <Button onClick={() => { onAdminClick(); setMobileOpen(false) }} className="w-full bg-[#0D1D3A] hover:bg-[#0D1D3A] text-[#1A1A2E] rounded-md text-sm">
                        <Shield className="w-3.5 h-3.5 mr-1.5" />
                        Dashboard
                      </Button>
                      <Button onClick={() => { onLogout?.(); setMobileOpen(false) }} variant="outline" className="w-full border-[#dddddd] text-[#666666] rounded-md text-sm">
                        <LogOut className="w-3.5 h-3.5 mr-1.5" />
                        Logout
                      </Button>
                    </>
