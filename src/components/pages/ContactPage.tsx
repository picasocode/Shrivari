    ...
    <div className="relative group">
      ...
      {multiline ? (
        <Textarea
          ...
          required={required}
          rows={4}
          className={`${shared} !pl-12 resize-none rounded-xl border-2 ${focused ? 'border-[#E8751A]/40' : 'border-[#dddddd]'} focus:border-[#E8751A]/60 focus:ring-0 transition-colors`}
        />
      ) : (
        <Input
          id={id}
          ...
          placeholder={placeholder}
          required={required}
          className={`${shared} h-14 rounded-xl border-2 ${focused ? 'border-[#E8751A]/40' : 'border-[#dddddd]'} focus:border-[#E8751A]/60 focus:ring-0 transition-colors`}
        />
      )}
...
/* ─── Contact Info ─── */
const contactInfo = [
  { icon: Phone, label: 'Phone', value: '+91 9941905833', href: 'tel:+919941905833', color: 'bg-[#0D1D3A]/10 text-[#444444]' },
                ...
                <Card className="bg-white rounded-2xl border-0 shadow-lg overflow-hidden">
                  <CardContent className="p-0">
                    ...
                    <div className="p-6 md:p-10">
                      ...
                      <p className="text-[#666666] text-sm mb-8">Fill out the form below and our team will get back to you within 24 hours.</p>
                      ...
                      <AnimatePresence>
                        {success && (
                          <motion.div
                            ...
                            className="flex items-center gap-3 bg-[#0D1D3A]/5 border border-[#5A7EA8] text-[#444444] px-5 py-4 rounded-xl mb-8"
                          >
                            <motion.div
                              initial={{ scale: 0 }}
                              animate={{ scale: 1 }}
                            ...
                            <div>
                              ...
                              <p className="text-sm text-[#444444]">We&apos;ll get back to you soon.</p>
                            </div>
                          </motion.div>
                        )}
                      </AnimatePresence>
            ...
            <div className="lg:col-span-2 space-y-4">
              {contactInfo.map((item, i) => (
                <FadeIn key={item.label} delay={i * 0.08}>
                  <Card className="group bg-white rounded-xl border border-[#dddddd] shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-default">
              ...
              {/* Map Section */}
              <FadeIn delay={0.32}>
                <Card className="rounded-xl border border-[#dddddd] overflow-hidden shadow-sm">
                  <div className="relative h-52 bg-gradient-to-br from-[#F0F4F8] to-[#E2E8F0]">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        >
                          <div className="w-12 h-12 rounded-full bg-[#0D1D3A] flex items-center justify-center mx-auto shadow-lg shadow-[#efefef]/30">
                        ...
                        <p className="text-sm text-[#666666]">Chennai, Tamil Nadu, India</p>
                      </div>
                    </div>
                  </div>
                </Card>
                  ...
                  <CardContent className="p-6 md:p-8">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-[#666666]">{office.address}</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <Phone className="w-4 h-4 text-[#9CA3AF] mt-0.5 shrink-0" />
                        <a href={`tel:${office.phone.replace(/\s/g, '')}`} className="text-sm text-[#666666] hover:text-[#E8751A] transition-colors">{office.phone}</a>
                      </div>
                      <div className="flex items-start gap-3">
                        <Mail className="w-4 h-4 text-[#9CA3AF] mt-0.5 shrink-0" />
                        <a href={`mailto:${office.email}`} className="text-sm text-[#666666] hover:text-[#E8751A] transition-colors">{office.email}</a>
                      </div>
                      <div className="flex items-start gap-3">
                        <Clock className="w-4 h-4 text-[#9CA3AF] mt-0.5 shrink-0" />
                        <span className="text-sm text-[#666666]">{office.hours}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
