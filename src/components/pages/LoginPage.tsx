                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 h-11 rounded-lg border-[#dddddd] focus:border-[#334155] focus:ring-[#efefef]/20"
                    />
                  </div>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 pr-10 h-11 rounded-lg border-[#dddddd] focus:border-[#334155] focus:ring-[#efefef]/20"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-[#666666] hover:text-[#1A1A2E] transition-colors"
                    >
