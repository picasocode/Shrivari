  ...
  return (
    <>
      ...
      <section className="py-16 md:py-24 bg-white relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#0D1D3A]/[0.02] rounded-full translate-y-1/3 -translate-x-1/3" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {whyJoinData.map((item, i) => (
              <FadeIn key={item.title} delay={i * 0.08}>
                <Card className="group bg-white rounded-xl border border-[#dddddd] shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden h-full card-hover">
        ...
        <div className="max-w-[1280px] mx-auto px-5 lg:px-8 relative z-10">
          ...
          <div className="relative">
            ...
            <div className="hidden lg:block absolute top-[50%] left-[16.67%] right-[16.67%] h-px">
              ...
              {/* Side dots */}
              <div className="absolute top-1/2 left-0 -translate-y-1/2 w-3 h-3 rounded-full bg-[#0D1D3A]/20 border-2 border-white" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {lifePillars.map((pillar, i) => (
                <FadeIn key={pillar.title} delay={i * 0.12}>
                  <Card className="group bg-white rounded-xl border border-[#dddddd] shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden h-full">
                    {/* Colored top bar */}
                    ...
                    <CardContent className="p-6">
                      ...
                      <p className="text-[#666666] text-sm leading-relaxed mb-5">{pillar.desc}</p>
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                    activeDepartment === dept.value
                      ? 'bg-[#0D1D3A] text-[#1A1A2E] shadow-md'
                      : 'bg-[#efefef] text-[#666666] hover:bg-[#E5E7EB] hover:text-[#1A1A2E]'
                  }`}
                >
                  {dept.label}
                </button>
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                              <Badge variant="outline" className="border-[#dddddd] text-[#374151] rounded-md px-2.5 py-0.5 text-sm font-medium gap-1">
      ...
      <section className="py-16 md:py-24 bg-[#efefef] relative overflow-hidden">
        ...
        <div className="absolute bottom-[10%] right-[5%] w-64 h-64 bg-[#0D1D3A]/[0.04] rounded-full blur-2xl" />

        <div className="max-w-[1280px] mx-auto px-5 lg:px-8 relative z-10">
          <div className="relative bg-white rounded-2xl shadow-xl border border-[#dddddd] overflow-hidden">
            {/* Top accent bar */}
                ...
                <FadeIn>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <a href="tel:+919941905833" className="flex items-center gap-3 group">
                      <div className="w-10 h-10 rounded-lg bg-[#0D1D3A]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#0D1D3A]/20 transition-colors">
                        <Phone className="w-5 h-5 text-[#444444]" />
                      </div>
                      <div>
                        <p className="text-[10px] text-[#9CA3AF] uppercase tracking-wider font-medium">Phone</p>
                        <p className="text-sm font-semibold text-[#1A1A2E] group-hover:text-[#444444] transition-colors">+91 9941905833</p>
                      </div>
                    </a>
                  </div>
