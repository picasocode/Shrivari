...
const accentMap: Record<string, AccentDef> = {
  'Design & Engineering':                              { bg: 'bg-[#334155]',     light: 'bg-[#334155]/5',   border: 'border-[#334155]',     text: 'text-[#334155]',     ring: 'ring-[#5A7EA8]' },
  ...
  'AMC':                                               { bg: 'bg-[#334155]',     light: 'bg-[#334155]/5',   border: 'border-[#334155]',     text: 'text-[#334155]',     ring: 'ring-[#5A7EA8]' },
...
const defaultAccent: AccentDef = {
  bg: 'bg-[#334155]', light: 'bg-[#334155]/5', border: 'border-[#334155]', text: 'text-[#334155]', ring: 'ring-[#5A7EA8]',
}
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isActive
                      ? 'bg-[#334155] text-[#1A1A2E] shadow-lg shadow-[#efefef]/20'
                  ...
                  >
                    ...
                    >
                      ...
                      <CardContent className="p-5">
                        {/* Title */}
                        <h3 className="text-lg font-bold text-[#1A1A2E] mb-2 leading-snug group-hover:text-[#334155] transition-colors">
                          {s.name}
                        </h3>
