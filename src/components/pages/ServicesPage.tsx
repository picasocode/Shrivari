...
const accentMap: Record<string, AccentDef> = {
  'Design & Engineering':                              { bg: 'bg-[#455a64]',     light: 'bg-[#455a64]/5',   border: 'border-[#334155]',     text: 'text-[#37474f]',     ring: 'ring-[#5A7EA8]' },
  ...
  'AMC':                                               { bg: 'bg-[#455a64]',     light: 'bg-[#455a64]/5',   border: 'border-[#334155]',     text: 'text-[#37474f]',     ring: 'ring-[#5A7EA8]' },
...
const defaultAccent: AccentDef = {
  bg: 'bg-[#455a64]', light: 'bg-[#455a64]/5', border: 'border-[#334155]', text: 'text-[#37474f]', ring: 'ring-[#5A7EA8]',
}
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isActive
                      ? 'bg-[#455a64] text-[#1A1A2E] shadow-lg shadow-[#efefef]/20'
                  ...
                  >
                    ...
                    >
                      ...
                      <CardContent className="p-5">
                        {/* Title */}
                        <h3 className="text-lg font-bold text-[#1A1A2E] mb-2 leading-snug group-hover:text-[#37474f] transition-colors">
                          {s.name}
                        </h3>
